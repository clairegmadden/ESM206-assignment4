...
iv_boxplot <- ggplot(iv_box, aes(x = YEAR, y = SIZE)) +
  ...
  labs(x = "Year", y = "Carapace Size (mm)", title = "Isla Vista")
...
napl_boxplot <- ggplot(napl_box, aes(x = YEAR, y = SIZE)) +
  ...
  theme_classic()+
  scale_y_continuous(breaks = seq(0, 160, by = 20), limits = c(0,160))+
  labs(x = "Year", y = "Carapace Size (mm)", title = "Naples Reef")
...
aq_boxplot <- ggplot(aq_box, aes(x = YEAR, y = SIZE)) +
  ...
  theme_classic()+
  scale_y_continuous(breaks = seq(0, 160, by = 20), limits = c(0,160))+
  labs(x = "Year", y = "Carapace Size (mm)", title = "Arroyo Quemado")
...
carp_boxplot <- ggplot(carp_box, aes(x = YEAR, y = SIZE)) +
  ...
  theme_classic()+
  scale_y_continuous(breaks = seq(0, 160, by = 20), limits = c(0,160))+
  labs(x = "Year", y = "Carapace Size (mm)", title = "Carpinteria")
...
mohk_boxplot <- ggplot(mohk_box, aes(x = YEAR, y = SIZE)) +
  ...
  theme_classic()+
  scale_y_continuous(breaks = seq(0, 160, by = 20), limits = c(0,160))+
  labs(x = "Year", y = "Carapace Size (mm)", title = "Mohawk Reef")
