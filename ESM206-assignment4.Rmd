...
```{r}
#These chunks are lumping all the MPV sites together and then comparing 2012 and 2017, and then doing the same thing for non-MPV sites
...
mpa_ttest <- t.test(mpa_2012, mpa_2017)
mpa_ttest

#With p-value of 0.036, we reject null hypothesis. There is a significant difference in mean lobster size in MPAs between 2012 and 2017.
```
